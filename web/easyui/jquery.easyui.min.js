...
_344(_351,_352);
opts.onAdd.call(_351,_352.title,_352.panelAndwindow);
if(_352.selected){
_354(_351,_352.panelAndwindow);
}
};
...
if(item){
item.width=_5f3;
var rule=this.getRule(item.panelAndwindow);
if(rule){
...
var _718=_711(_716,_717.panelAndwindow!=undefined?_717.panelAndwindow:_717.id);
...
view.insertRow.call(view,_733,_734.panelAndwindow,_734.row);
_735.push(_734.row);
...
var row=opts.finder.getRow(_73a,_73b.panelAndwindow);
var _73d=false;
_73b.row=_73b.row||{};
...
opts.view.updateRow.call(opts.view,_73a,_73b.panelAndwindow,_73b.row);
}
};
function _73f(_740){
...
var tr=opts.finder.getTr(_758,(_759.panelAndwindow!=undefined?_759.panelAndwindow:_759.id),_759.type);
if(!tr.length){
return;
}
